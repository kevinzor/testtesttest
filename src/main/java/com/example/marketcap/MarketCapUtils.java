...
/**
 * Utility class responsible for fetching and parsing the USD market cap from the Pump.fun API.
 */
public final class MarketCapUtils {
    // Pump.fun API endpoint for your token.
    private static final String TOKEN_URL =
        "https://frontend-api-v3.pump.fun/coins/58BMhEDSY1ySm7g87zDU63bbeP9SPpkoYSKroD19pump";

    // User-Agent header to mimic a regular browser. Some sites block requests without a user agent.
    private static final String USER_AGENT =
        "Mozilla/5.0 (compatible; MarketCapFetcher/1.0; +https://pump.fun)";
    ...
    /**
     * Fetches the pump.fun API and extracts the usd_market_cap value.
     *
    ...
    public static String fetchMarketCap() {
        ...
        try {
            ...
            // Find the index of the usd_market_cap field in the JSON.
